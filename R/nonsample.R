#' @title data nonsample
#' @description This data similar to \code{dataME} but have 9 non-sampled area. Generated by following these steps:
#' \enumerate{
...
#' }
#' Direct estimator \code{y}, auxiliary variable \eqn{\hat{x}}{x.hat}, sampling variance \eqn{\psi}{\psi}, and  \eqn{c}{c} are arranged in a dataframe called \code{nonsample}.
#' @usage data(nonsample)
